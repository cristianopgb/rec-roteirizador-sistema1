...
export function CarteiraDataGrid({ items, itemsCount }: CarteiraDataGridProps) {
  const allColumns = useMemo(() => {
    const cols = [
      ...
      { key: 'romane', label: 'Romanei', width: '120px' },
      { key: 'filial_d', label: 'Filial', width: '100px' },
      { key: 'serie', label: 'Série D', width: '100px' },
      { key: 'nro_doc', label: 'Nro Do', width: '120px' },
      { key: 'data_des', label: 'Data D', width: '110px' },
      { key: 'data_nf', label: 'Data N', width: '110px' },
      ...
      { key: 'classif', label: 'Classifica', width: '100px' },
      { key: 'tomad', label: 'Tomad', width: '200px' },
      { key: 'destin', label: 'Destina', width: '200px' },
      { key: 'bairro', label: 'Bairro', width: '150px' },
      { key: 'cidade', label: 'Cida', width: '150px' },
      { key: 'uf', label: 'UF', width: '60px' },
      { key: 'nf_serie', label: 'NF/Ser', width: '120px' },
      { key: 'tipo_carga', label: 'Tipo Carga', width: '120px' },
      { key: 'tipo_ca', label: 'Tipo Carg', width: '100px' },
      { key: 'qtd_nf', label: 'Qtd.NF', width: '80px' },
      { key: 'sub_regiao', label: 'Sub-Região', width: '150px' },
      { key: 'ocorrencias_nf', label: 'Ocorrências N', width: '150px' },
      { key: 'remetente', label: 'Remetente', width: '200px' },
      { key: 'observacao', label: 'Observação R', width: '200px' },
      ...
      { key: 'ultima_ocorrencia', label: 'Última Ocorrê', width: '150px' },
      { key: 'status_r', label: 'Status Rom. O', width: '130px' },
      ...
      { key: 'restricao_veiculo', label: 'Restrição Veíc', width: '140px' },
